        ...
        */}
        ...
        <Reveal className="mt-24 md:mt-32">
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            {/* One column on a phone, where a half-width 16:10 tile is barely
                160px across and the briefing's inset would be unreadable. */}
                ...
                >
                  ...
                  {"inset" in ph && ph.inset && (
                    ...
                    <img
                      ...
                      alt={ph.inset.alt}
                      loading="lazy"
                      className="absolute top-[4%] right-[4%] w-[38%] sm:w-[34%] aspect-[4/3] object-cover rounded-lg ring-[3px] ring-cream/90 shadow-[0_10px_28px_rgba(10,15,12,0.45)]"
                    />
                  )}
